...
# from geoseg.models.umamba_t.umamba_t import UMamba
from geoseg.models.urbanssf_s_69.umamba_s import UMamba
# from geoseg.models.urbanssf_l_test.urbanssf_l import UMamba
...
train_dataset = PotsdamDataset(data_root='/home/kotlin/DATASET/potsdam/train', mode='train',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(data_root='/home/kotlin/DATASET/potsdam/test', transform=val_aug)
test_dataset = PotsdamDataset(data_root='/home/kotlin/DATASET/potsdam/test',
                              transform=val_aug)
