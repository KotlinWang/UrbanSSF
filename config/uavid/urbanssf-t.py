...
from geoseg.models.urbanssf_t.umamba_t import UMamba
...
val_dataset = UAVIDDataset(data_root='/root/data/dataset/uavid/test', img_dir='images', mask_dir='masks', mode='val',
                           mosaic_ratio=0.0, transform=val_aug, img_size=(1024, 1024))
test_dataset = UAVIDDataset(data_root='/root/data/dataset/uavid/test', img_dir='images', mask_dir='masks', mode='val',
                           mosaic_ratio=0.0, transform=val_aug, img_size=(1024, 1024))
