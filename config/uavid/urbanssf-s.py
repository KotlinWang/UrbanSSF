...
from geoseg.models.urbanssf_s.umamba_s import UMamba
...
weights_name = "urbanssf-s-val"
weights_path = "model_weights/uavid/{}".format(weights_name)
test_weights_name = "urbanssf-s-val"
...
train_dataset = UAVIDDataset(data_root='/root/data/dataset/uavid/train', img_dir='images', mask_dir='masks',
                             mode='train', mosaic_ratio=0.25, transform=train_aug, img_size=(1024, 1024))

val_dataset = UAVIDDataset(data_root='/root/data/dataset/uavid/val', img_dir='images', mask_dir='masks', mode='val',
                           mosaic_ratio=0.0, transform=val_aug, img_size=(1024, 1024))
test_dataset = UAVIDDataset(data_root='/root/data/dataset/uavid/val', img_dir='images', mask_dir='masks', mode='val',
                           mosaic_ratio=0.0, transform=val_aug, img_size=(1024, 1024))
